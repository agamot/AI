...
img = cv2.imread(r'D:\PycharmProjects\IA\experiment.jpg')
#img = cv2.resize(img, (800,600))
#cv2.imshow('Imagine dimensionata', img)
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
gray = cv2.bilateralFilter(gray, 13, 15, 15)
cv2.imshow('Imagine cu filtru gray', gray)
#cv2.waitKey(0)
...
print("Numarul de inmatriculare este ", text_numar)
